...
const Footer = () => {
  ...
  return (
    <>
      <h2 className='head-text'>Contact Me & Start Your Business</h2>

      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          <img src={images.email} alt='email' />
          <a href='mailto:adriansoftwaredeveloper@gmail.com' className='p-text'>adriansoftwaredeveloper@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt='mobile' />
          <a href='tel: +34 622 07 36 82' className='p-text'>+34 622 07 36 82</a>
        </div>
      </div>
    ...
    {!IsFormSubmitted ?
      ...
      : 
      <div>
        <h3 className='head-text'>Thanks you for contacting</h3>
      </div>
    }
    </>
  )
